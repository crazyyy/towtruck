...
( function( e, t ) {
  e.submitform = function( e, o, n ) {
    ...
    strings: {},
    _ ( t, o ) {
      const n = e.getOptions( 'joomla.jtext' );
    ...
    load ( e ) {
      for ( const t in e ) { e.hasOwnProperty( t ) && ( this.strings[t.toUpperCase()] = e[t] ); }
    ...
    if ( e.optionsStorage ) {
      if ( o ) { for ( const c in o ) { o.hasOwnProperty( c ) && ( e.optionsStorage[c] = o[c] ); } }
    ...
    for ( var s = t.createElement( 'select' ), l = e.split( ' ' ), d = 0; d < l.length; d++ ) {
      ...
      'on' !== c[0].trim().substr( 0, 2 )
        .toLowerCase() && 'href' !== c[0].trim().toLowerCase() && s.setAttribute( c[0], c[1].replace( /\"/g, '' ) );
    }
    let u, m, p,
      h = n == r;
    ...
    for ( u = 0; u < o.length; u++ ) {
      if ( ( p = o[u] )[0] == n ) {
        m = h ? a == p[1] : 0 === u;
        const f = t.createElement( 'option' );
    ...
    if ( o = o || 'show', n = n || t.body, 'load' === o ) {
      const r = ( e.getOptions( 'system.paths' ) || {} ).root || '',
    ...
    try {
      ...
      if ( o.open( t.method, t.url, !0 ), o.setRequestHeader( 'X-Requested-With', 'XMLHttpRequest' ), o.setRequestHeader( 'X-Ajax-Engine', 'Joomla!' ), 'POST' === t.method ) {
        const n = e.getOptions( 'csrf.token', '' );
      ...
      if ( t.headers ) { for ( const r in t.headers ) { t.headers.hasOwnProperty( r ) && o.setRequestHeader( r, t.headers[r] ); } }
