! function(t) {
  ...
  i.VERSION = "3.2.0", i.prototype.close = function(e) {
    ...
    e && e.preventDefault(), s.length || (s = i.hasClass("sppb-alert") ? i : i.parent()), s.trigger(e = t.Event("close.sppb.alert")), e.isDefaultPrevented() || (s.removeClass("in"), t.support.transition && s.hasClass("sppb-fade") ? s.one("bsTransitionEnd", o).emulateTransitionEnd(150) : o())
  };
  var n = t.fn.spbalert;
  ...
  function(t) {
    ...
    function i(i) {
      return this.each(function() {
        ...
        s || n.data("sppb.carousel", s = new e(this, o)), "number" == typeof i ? s.to(i) : a ? s[a]() : o.interval && s.pause().cycle()
      })
    }
    e.VERSION = "3.2.0", e.DEFAULTS = {
      ...
      if (this.$element.trigger(d), !d.isDefaultPrevented()) {
        ...
        return t.support.transition && this.$element.hasClass("sppb-slide") ? (s.addClass(e), s[0].offsetWidth, n.addClass(a), s.addClass(a), n.one("bsTransitionEnd", function() {
          s.removeClass([e, a].join(" ")).addClass("active"), n.removeClass(["active", a].join(" ")), p.sliding = !1, setTimeout(function() {
            p.$element.trigger(c)
          }, 0)
        }).emulateTransitionEnd(1e3 * n.css("transition-duration").slice(0, -1))) : (n.removeClass("active"), s.addClass("active"), this.sliding = !1, this.$element.trigger(c)), o && this.cycle(), this
      }
    };
    ...
    t.fn.sppbcarousel = i, t.fn.sppbcarousel.Constructor = e, t.fn.sppbcarousel.noConflict = function() {
      ...
      t(".sppb-carousel").each(function(e) {
        var i = t(this).find(".sppb-item"),
          ...
          s = "";
        t(this).attr("id", n);
        for (var o = 0; o < i.length; o++) s += 0 == o ? '<li data-sppb-target="#' + n + '" class="active" data-sppb-slide-to="0"></li>' : '\n<li data-sppb-target="#' + n + '" data-sppb-slide-to="' + o + '"></li>';
      ...
      var n, s = t(this),
        o = t(s.attr("data-sppb-target") || (n = s.attr("href")) && n.replace(/.*(?=#[^\s]+$)/, ""));
      if (o.hasClass("sppb-carousel")) {
        var a = t.extend({}, o.data(), s.data()),
          r = s.attr("data-sppb-slide-to");
        r && (a.interval = !1), i.call(o, a), r && o.data("sppb.carousel").to(r), e.preventDefault()
      }
  ...
  function(t) {
    ...
    e.VERSION = "3.2.0", e.prototype.show = function() {
      ...
      function a() {
        s.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"), e.addClass("active"), o ? (e[0].offsetWidth, e.addClass("in")) : e.removeClass("sppb-fade"), e.parent(".dropdown-menu") && e.closest("li.dropdown").addClass("active"), n && n()
      }
      o ? s.one("bsTransitionEnd", a).emulateTransitionEnd(150) : a(), s.removeClass("in")
    };
    var n = t.fn.sppbtab;
    ...
    e.VERSION = "3.2.0", e.DEFAULTS = {
      ...
      for (var s = this.options.trigger.split(" "), o = s.length; o--;) {
        ...
        if ("click" == a) this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this));
          ...
          this.$element.on(r + "." + this.type, this.options.selector, t.proxy(this.enter, this)), this.$element.on(p + "." + this.type, this.options.selector, t.proxy(this.leave, this))
        }
      }
      ...
      if (this.hasContent() && this.enabled) {
        ...
        this.setContent(), s.attr("id", o), this.$element.attr("aria-describedby", o), this.options.animation && s.addClass("sppb-fade");
        var a = "function" == typeof this.options.placement ? this.options.placement.call(this, s[0], this.$element[0]) : this.options.placement,
          r = /\s?auto?\s?/i,
          p = r.test(a);
        p && (a = a.replace(r, "") || "top"), s.detach().css({
          top: 0,
          left: 0,
          display: "block"
        }).addClass(a).data("sppb." + this.type, this), this.options.container ? s.appendTo(this.options.container) : s.insertAfter(this.$element);
        ...
        if (p) {
          ...
          a = "bottom" == a && l.top + l.height + h - f.scroll > f.height ? "top" : "top" == a && l.top - f.scroll - h < 0 ? "bottom" : "right" == a && l.right + d > f.width ? "left" : "left" == a && l.left - d < f.left ? "right" : a, s.removeClass(c).addClass(a)
        }
        ...
        t.support.transition && this.$tip.hasClass("sppb-") ? s.one("bsTransitionEnd", m).emulateTransitionEnd(150) : m()
      }
      ...
      if (/right|left/.test(t)) {
        ...
        r < a.top ? s.top = a.top - r : p > a.top + a.height && (s.top = a.top + a.height - p)
      } else {
        var l = e.left - o,
          d = e.left + o + i;
        l < a.left ? s.left = a.left - l : d > a.width && (s.left = a.left + a.width - d)
      }
      return s
    ...
    t.fn.sppbtooltip = function(i) {
      return this.each(function() {
        var n = t(this),
          ...
          o = "object" == typeof i && i;
        (s || "destroy" != i) && (s || n.data("sppb.tooltip", s = new e(this, o)), "string" == typeof i && s[i]())
      })
    ...
    t.fn.sppbpopover = function(i) {
      return this.each(function() {
        var n = t(this),
          ...
          o = "object" == typeof i && i;
        (s || "destroy" != i) && (s || n.data("sppb.popover", s = new e(this, o)), "string" == typeof i && s[i]())
      })
...
carousel && jQuery(window).on("ready", function() {
  ...
  function() {
    ...
    e = function() {
      ...
      return o.prototype.defaults = {
        ...
        return this.config.live ? new t((o = this, function(t) {
          var e, i, n, s, a;
          for (a = [], n = 0, s = t.length; s > n; n++) i = t[n], a.push(function() {
            var t, n, s, o;
            for (o = [], t = 0, n = (s = i.addedNodes || []).length; n > t; t++) e = s[t], o.push(this.doSync(e));
            return o
          }.call(o));
          return a
        ...
        if (!this.stopped) {
          ...
          for (a = [], i = 0, n = (o = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; n > i; i++) e = o[i], s.call(this.all, e) < 0 ? (this.applyStyle(e, !0), this.boxes.push(e), this.all.push(e), a.push(this.scrolled = !0)) : a.push(void 0);
          return a
        }
        ...
        var i, n, s, o;
        return n = t.getAttribute("data-sppb-wow-duration"), i = t.getAttribute("data-sppb-wow-delay"), s = t.getAttribute("data-sppb-wow-iteration"), this.animate((o = this, function() {
        ...
        var i, n, s, o;
        for (i in o = [], e) n = e[i], t["" + i] = n, o.push(function() {
          var e, o, a, r;
          for (r = [], e = 0, o = (a = this.vendors).length; o > e; e++) s = a[e], r.push(t["" + s + i.charAt(0).toUpperCase() + i.substr(1)] = n);
          return r
        }.call(this));
        return o
      }, o.prototype.vendorCSS = function(t, e) {
        var i, n, s, o, a, r;
        for (i = (n = window.getComputedStyle(t)).getPropertyCSSValue(e), o = 0, a = (r = this.vendors).length; a > o; o++) s = r[o], i = i || n.getPropertyCSSValue("-" + s + "-" + e);
        return i
        ...
        var e, i, n, s, o;
        return i = t.getAttribute("data-sppb-wow-offset") || this.config.offset, s = (o = window.pageYOffset) + Math.min(this.element.clientHeight, innerHeight) - i, e = (n = this.offsetTop(t)) + t.clientHeight, s >= n && e >= o
    ...
    function l() {
      ...
      if (t.each(s, function(t, e) {
        ...
        for (e = e || ((d = {
          ...
          width: a.innerWidth
        }).height || !(p = o.compatMode) && t.support.boxModel || (d = {
          ...
          if (t.contains(r, h[c])) {
            var u, f, v, m = t(h[c]),
              ...
              w = m.data("inview");
            if (!i || !e) return;
            g.top + b > i.top && g.top < i.top + e.height && g.left + y > i.left && g.left < i.left + e.width ? (v = (u = i.left > g.left ? "right" : i.left + e.width < g.left + y ? "left" : "both") + "-" + (f = i.top > g.top ? "bottom" : i.top + e.height < g.top + b ? "top" : "both"), w && w === v || m.data("inview", v).trigger("inview", [!0, u, f])) : w && m.data("inview", !1).trigger("inview", [!1])
          }
    }
    t.event.special.inview = {
      ...
      return this.each(function() {
        ...
        i = void 0 === i || i, t({
          ...
          step: function() {
            o.text(Math.floor(this.value)), i && o.text(o.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"))
          },
          complete: function() {
            parseInt(o.text()) !== e && (o.text(e), i && o.text(o.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")))
          }
        })
      })
    }, t(document).on("inview", ".sppb-animated-number", function(e, i, n, s) {
      var o = t(this);
      i && (o.sppbanimateNumbers(o.data("digit"), !1, o.data("duration")), o.unbind("inview"))
  ...
  t(document).on("submit", ".sppb-ajaxt-contact-form", function(e) {
    ...
    return t.ajax({
      ...
      success: function(e) {
        ...
        "json" == a ? s.status && i.trigger("reset") : i.trigger("reset"), i.find(".fa-spin").removeClass("fa-spinner fa-spin"), i.next(".sppb-ajax-contact-status").html(o).fadeIn().delay(4e3).fadeOut(500)
      }
    }), !1
  })
}), jQuery(function(t) {
  t(document).on("submit", ".sppb-optin-form", function(e) {
    ...
    return t.ajax({
      ...
      success: function(e) {
        ...
        i.find(".fa-spin").removeClass("fa-spinner fa-spin"), i.next(".sppb-optin-form-status").html('<p class="' + o + '">' + s.content + "</p>").fadeIn().delay(4e3).fadeOut(1e3)
      }
    }), !1
  })
}), jQuery(function(t) {
    ...
    e.prototype.init = function() {
      ...
      e.each(function() {
        ...
        if (e.hasClass("loading-bar")) i = n.barAnimationDelay, setTimeout(function() {
          ...
          var a = e.find(".animated-text-words-wrapper .animated-text.is-visible");
      ...
      }, o.animationDelay) : setTimeout(function() {
  ...
  function(t) {
    function e() {
      if ("undefined" == typeof stickyParent && (stickyParent = t('[data-sticky-it="true"]').parents(".sppb-section ")), !("undefined" == typeof stickyParent || 0 == stickyParent.length || t(window).width() <= 767)) {
    ...
    window.sppbVideoBackgroundResize = function(t) {
      ...
      void 0 !== jQuery.fn.parallax && t('[data-sppb-parallax="on"]').parallax();
